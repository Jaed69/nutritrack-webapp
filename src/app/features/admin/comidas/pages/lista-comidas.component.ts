    ...
    <div class="page-container">
      <div class="page-header">
        <div class="header-content">
          ...
          <p class="page-subtitle">Administra las comidas disponibles en el sistema</p>
        </div>
        <button mat-raised-button color="primary" routerLink="/admin/comidas/crear">
      ...
      <mat-card>
        <mat-card-content>
          <div class="empty-state">
            ...
            <p>Comienza creando tu primera comida para el sistema</p>
            <button mat-raised-button color="primary" routerLink="/admin/comidas/crear">
              <mat-icon>add</mat-icon>
